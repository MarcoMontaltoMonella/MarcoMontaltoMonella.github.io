...
def generate_llms(posts):
    ...
    return (
        ...
        "the side). Beyond engineering he teaches yoga sculpt, is writing his "
        "first book, and is a passionate chef who invests in and advises "
        "Nonna Gnocchi because he believes in Italian cuisine. He cares about "
        "innovation, health, and the environment, and stays active with "
        "gymnastics, beach volleyball, and running.\n\n"
        "## Main pages\n\n"
